...
Введите в адресной строке браузера URL, который соответствует URL шаблону, связанному с DetailsView \(http://127.0.0.1:8000/bucketlists/1/\). И вуаля - все работает! Теперь Вы можете отредактировать существующий список заветных желаний. 
...
> Существует также перевод данного руководства на русский язык, доступный по адресу http://djbook.ru/rel1.9/intro/tutorial01.html.
