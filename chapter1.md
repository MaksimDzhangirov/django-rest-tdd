...
В Django мы можем создать несколько приложений, которые вместе формируют одно большое приложение. Приложение в Django - это просто python пакет с множеством файлов, одним из которых является _`init`_`.py.`
